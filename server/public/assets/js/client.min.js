...
var app=angular.module("tryoutsApp",["ngRoute","mobile-angular-ui","mobile-angular-ui.gestures","pickadate"]);app.config(["$routeProvider","$locationProvider",function(a,b){a.when("/",{templateUrl:"/app/view/",controller:"LoginController",controllerAs:"login"}).when("/logout",{templateUrl:"/app/view/",controller:"LogoutController",controllerAs:"logout"}).when("/archives",{templateUrl:"/app/view/archives",controller:"ArchivesController",controllerAs:"archive"}).when("/new",{templateUrl:"/app/view/new",controller:"TryoutInputController",controllerAs:"input"}).when("/review",{templateUrl:"/app/view/review",controller:"ReviewInputController",controllerAs:"rev"}),b.html5Mode(!0)}]),app.controller("AppController",["UserService",function(a){var b=this;b.user=a.user,a.isAuthenticated(function(a,b){console.log(a)})}]),app.controller("LoginController",["$http","UserService","TryoutService",function(a,b,c){var d=this;d.tryouts=[],d.guest={},b.isAuthenticated(function(b){if(b===!0){var e=function(){a.get("/app/view/data").then(function(a){return 200!==a.status,d.tryouts=a.data,console.log(a.data),a.data})};e()}d.generateGuestCode=function(a){c.generateCode(a),e()}}),d.guestLogin=function(){console.log(d.guest),b.guestAuthentication(d.guest)}}]),app.controller("TryoutInputController",["TryoutService",function(a){var b=this,c=1;b.curDate=new Date,b.curTime=new Date,b.tryout={},b.categories=[{id:1}],b.addField=function(){c+=1,b.categories.push({id:c})},b.removeField=function(a){b.categories.splice(a,1)},b.submitInfo=function(){b.tryout.categories=b.categories,a.saveTryoutInfo(b.tryout)}}]),app.controller("TryoutManagementController",["$http",function(a){}]),app.controller("LogoutController",["UserService","$templateCache","$location",function(a,b,c){b.removeAll(),a.isAuthenticated(function(b){b===!0?a.logout(function(){c.path("/")}):c.path("/")})}]),app.controller("ArchivesController",function(){}),app.factory("UserService",["$http",function(a){var b={},c=function(b){a.get("/auth/logout").then(function(a){b()})},d=function(c){a.get("/auth/check").then(function(a){a.data.success===!0?(b.data=a.data.user,c(!0,a.data)):(b.data=a.data,c(!1))})},e=function(b){a.post("/auth/guest",b).then(function(a){console.log(a)})};return{user:b,logout:c,isAuthenticated:d,guestAuthentication:e}}]),app.factory("TryoutService",["$http",function(a){var b=[],c=function(b){a.post("/app/view/new",b).then(function(a){console.log(a)})},d=function(b){a.get("/app/view/guestcode/"+b._id).then(function(a){console.log("response.data",a.data)})},e=function(){var a=sessionStorage.getItem("test");console.log(a)};return{saveTryoutInfo:c,getTryoutInfo:e,generateCode:d,data:b}}]);
>>>>>>> 24bf4dcf8068d5886e79f7316245cf11a0cd2cf0
